...
​	用来限定前面的字符出现0次或者1次。简单来说就是'?'前面的字符可有可无。

![image-20220515233742690](https://konjacer-blog-img-repo.oss-cn-qingdao.aliyuncs.com/img/image-20220515233742690.png)

## *

​	用来限定前面的字符出现0次、1次或多次。

![image-20220515233801176](https://konjacer-blog-img-repo.oss-cn-qingdao.aliyuncs.com/img/image-20220515233801176.png)

## +

​	用来限定前面的字符出现1次或多次。

![image-20220515233819782](https://konjacer-blog-img-repo.oss-cn-qingdao.aliyuncs.com/img/image-20220515233819782.png)

## { num1 , [num2] }

​	用来限定前面的字符出现num1至num2次，num2可以省略，如果num2省略则代表前面的字符至少出现num1次。

![image-20220515233841198](https://konjacer-blog-img-repo.oss-cn-qingdao.aliyuncs.com/img/image-20220515233841198.png)

![image-20220515233903054](https://konjacer-blog-img-repo.oss-cn-qingdao.aliyuncs.com/img/image-20220515233903054.png)

## ()

​	括号不是限定符，用括号括起来的字符组可以被当作一个字符来使用限定符。

![image-20220515233923850](https://konjacer-blog-img-repo.oss-cn-qingdao.aliyuncs.com/img/image-20220515233923850.png)

# 或运算

​	用'|'来表示或运算，注意合理添加括号防止发生歧义。

![image-20220515233938013](https://konjacer-blog-img-repo.oss-cn-qingdao.aliyuncs.com/img/image-20220515233938013.png)

# 字符类

## []

​	方括号要求匹配的字符只能取决于方括号里的内容。

![image-20220515234233923](https://konjacer-blog-img-repo.oss-cn-qingdao.aliyuncs.com/img/image-20220515234233923.png)
